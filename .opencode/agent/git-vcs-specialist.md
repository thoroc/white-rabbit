...
This agent uses @task/dev/vcs-detection.md to determine the appropriate workflow:
...
**Resource:** `@task/dev/vcs-detection.md`
...
**Resource:** `@knowledge-base/dev/conventional-commits.md`
...
**Resource:** `@checklist/dev/git-operations-pre-commit.md`
...
**Resource:** `@task/dev/git-operations-execution.md`
...
**Resource:** `@knowledge-base/dev/git-operations-reference.md`
...
- `.opencode/knowledge-base/dev/conventional-commits.md` - Commit message patterns
- `.opencode/checklist/dev/git-operations-pre-commit.md` - Pre-commit checks
- `.opencode/task/dev/git-operations-execution.md` - Complex workflows
- `.opencode/knowledge-base/dev/git-operations-reference.md` - Strategic guidance
