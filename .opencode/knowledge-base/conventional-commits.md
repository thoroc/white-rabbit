...
- This file is intentionally concise — point contributors to the official spec for full details.
- Keep examples aligned to the project's commit conventions; adjust allowed types if your project restricts them.
