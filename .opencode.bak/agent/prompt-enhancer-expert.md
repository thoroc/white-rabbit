...
- Knowledge Base: `knowledge-base/prompt-engineering.md` - Prompt design patterns and best practices
- Template: `template/prompt-evaluation-tmpl.yaml` - Structured prompt quality assessment
- Checklist: `checklist/prompt-quality.md` - Comprehensive prompt quality criteria
