...
- `.opencode/checklist/documentation-discovery.md`: **Documentation discovery and analysis** (85+ items) - **USE FIRST**
- `.opencode/checklist/api-documentation.md`: API documentation requirements (150 items)
- `.opencode/checklist/architecture-documentation.md`: Architecture standards (161 items)
- `.opencode/checklist/deployment-documentation.md`: Deployment procedures (183 items)
- `.opencode/checklist/development-documentation.md`: Development workflows (181 items)
- `.opencode/checklist/onboarding-documentation.md`: Onboarding requirements (150 items)

### Knowledge Base

- `.opencode/knowledge-base/mermaid-diagrams.md`: Diagram templates and examples
- `.opencode/knowledge-base/loading-strategy.md`: Efficient resource loading guide

### Tasks

- `.opencode/task/documentation-discovery.md`: **Comprehensive documentation discovery** (374 lines) - **USE FIRST**
- `.opencode/task/project-context.md`: **Quick project analysis** (402 lines) - Lightweight shell commands
- `.opencode/task/technology-detection.md`: Technology stack analysis (226 lines)
- `.opencode/task/infrastructure-analysis.md`: Infrastructure patterns (281 lines)
- `.opencode/task/deployment-strategy.md`: Deployment strategies (398 lines)

### Templates

- `.opencode/template/standard-doc-structure-tmpl.yaml`: Standard documentation structure
- `.opencode/template/task-reference-template-tmpl.yaml`: Task reference patterns
- `.opencode/template/common-shell-commands-tmpl.yaml`: Lightweight analysis commands
...
1. **Documentation Discovery (ALWAYS FIRST)**
    ...
    - Use `.opencode/task/documentation-discovery.md` to find ALL existing documentation at ANY depth
    ...
    - Use `.opencode/checklist/documentation-discovery.md` for 85+ analysis verification points
...
- **ALWAYS discover existing documentation first** using `.opencode/task/documentation-discovery.md`
...
`.opencode/task/documentation-discovery.md`. They will:
...
- Knowledge base: `.opencode/knowledge-base/mermaid-diagrams.md` contains diagram templates and examples

### Resource Loading Strategy

**IMPORTANT**: The system uses efficient lazy loading to avoid unnecessary context usage.

**Loading Strategy Guide**: `.opencode/knowledge-base/loading-strategy.md`
...
1. **ALWAYS discover first**: Run `.opencode/task/documentation-discovery.md` before any documentation work
...
0. **Documentation Discovery Phase** (MANDATORY FIRST STEP):
    - Run comprehensive discovery using `.opencode/task/documentation-discovery.md`
    ...
    - Use `.opencode/checklist/documentation-discovery.md` for verification (85+ points)
